...
<nav className="flex justify-between mx-auto mt-[20px] bg-[#688273] bg-opacity-90  -2 h-[65px] ">

<img className="mt-[16px] ml-[22px] w-[98px] h-8"
src="/Logo/LogoFootyAI copy 5.png" alt="FootyAI Logo" />
        <div className="navPart2 w-[52%] justify-between flex gap-4 "> 
        <div className="items-center w-[77%] ml-[278px] flex">
            ...
            <div className="items-center justify-around w-[23%] flex"> 
